...
function loginPage(message = '') {
  return new Response(`<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Connexion — ADP Studio</title><link rel="icon" href="/favicon.ico?v=2" sizes="any"><link rel="icon" type="image/svg+xml" href="/favicon-studio.svg?v=2"><link rel="apple-touch-icon" href="/apple-touch-icon.png?v=2"><style>
